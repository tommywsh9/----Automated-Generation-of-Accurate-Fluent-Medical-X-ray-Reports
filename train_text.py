...
if DATASET_NAME == 'MIMIC':
    ...
    BATCH_SIZE = 2 if PHASE == 'TRAIN' else 16 # Fit 1 GPU
...
if __name__ == "__main__":
    ...
    if DATASET_NAME == 'MIMIC':
        ...
        dataset = MIMIC('E:/XRay/Vocabulary/', INPUT_SIZE, view_pos=['AP','PA','LATERAL'], max_views=MAX_VIEWS, sources=SOURCES, targets=TARGETS)
        ...
        dataset = NLMCXR('E:/XRay/Vocabulary/', INPUT_SIZE, view_pos=['AP','PA','LATERAL'], max_views=MAX_VIEWS, sources=SOURCES, targets=TARGETS)
    ...
    checkpoint_path_from = 'E:/XRay/checkpoints/{}_{}_{}.pt'.format(DATASET_NAME,MODEL_NAME,COMMENT)
    checkpoint_path_to = 'E:/XRay/checkpoints/{}_{}_{}.pt'.format(DATASET_NAME,MODEL_NAME,COMMENT)
