...
if __name__ == "__main__":
    ...
    # --- Choose a Dataset ---
    NLMCXR_dataset = NLMCXR('E:/XRay/Vocabulary/', view_pos=['AP','PA','LATERAL'], sources=SOURCES, targets=TARGETS, vocab_file='mimic_unigram_1000.model')
    dataset = NLMCXR('E:/XRay/Vocabulary/', view_pos=['AP','PA','LATERAL'], sources=SOURCES, targets=TARGETS, vocab_file='mimic_unigram_1000.model')
    dataset = NLMCXR('E:/XRay/Vocabulary/', view_pos=['AP','PA','LATERAL'], sources=SOURCES, targets=TARGETS, vocab_file='mimic_unigram_1000.model')
    ...
    # --- Main program ---
    data_loader = data.DataLoader(dataset, batch_size=BATCH_SIZE, shuffle=False, num_workers=2)
